...
router.get('/mailchimp', async (req, res) => {
  try {
    ...
    console.error(`Error in mailchimp endpoint ${error.message}`);
  }
});
...
router.post('/mailchimp/createList', async (req, res) => {
  try {
    ...
    console.error(`Error in mailchimp createlist endpoint ${error.message}`);
...
router.post('/mailchimp/createMergeField', async (req, res) => {
  try {
    ...
    console.error(`error generated by merge field endpoint: ${error.message}`);
    res.status(401).json(error.message);
  }
});
